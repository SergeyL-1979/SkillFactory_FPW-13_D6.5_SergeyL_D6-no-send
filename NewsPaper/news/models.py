...
class Category(models.Model):
    category_name = models.CharField('Категория', max_length=64, unique=True)
    subscriber = models.ManyToManyField(User, blank=True, null=True)
    # subscriber = models.ForeignKey(User, on_delete=models.ManyToManyField, blank=True, null=True, )
